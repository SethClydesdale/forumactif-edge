  ...
  
  {
    ...
    func : function(d) {
      ...
      if (form) {
        ...
        .replace(/<a class="button1 cgu-buttons" href="{U_AGREE_OVER13}">{AGREE_OVER_13}<\/a>&nbsp;&nbsp;\n\s+?<a class="button2 cgu-buttons" href="{U_INDEX}">{DO_NOT_AGREE}<\/a>&nbsp;&nbsp;\n\s+?<a class="button2 cgu-buttons" href="{U_INDEX}">{DO_NOT_AGREE}<\/a>/, '<input type="submit" value="{AGREE_OVER_13}" class="button1 cgu-buttons" />')
      }
    }
  },
