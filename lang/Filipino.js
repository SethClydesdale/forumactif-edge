...
// Translation by Wilson (http://fmdesign.forumotion.com/t990-forumactif-edge-filipino-translation#20084)
FAE.lang = {
  ...
  css : {
    ...
    online : 'NAKA-ONLINE',
    total_posts : 'Total ng mga posts',
    total_topics : 'Total ng mga topics',
    total_users : 'Total ng mga miyembro',
    record_users : 'Pinakamaraming miyembrong online',
    board_age : 'Edad ng forum (araw)',
    newest_member : 'Bagong miyembro',
    hidebox : 'Nakakubli:',
    chatbox_tip : 'I-hover dito para makita ang mga online',
    chatbox_no_away : 'Walang miyembro ang kasalukuyang wala rito.',
    chatbox_no_online : 'Walang miyembro ang kasalukuyang nandito.'
  },
  ...
  images : {
    ...
    buttons : {
      i_post : 'https://i35.servimg.com/u/f35/18/21/60/73/new-to15.png?color=primary&size=m',
      i_reply : 'https://i35.servimg.com/u/f35/18/21/60/73/post-r15.png?color=primary&size=m',
      i_reply_locked : 'https://i35.servimg.com/u/f35/18/21/60/73/locked15.png?color=secondary&size=m',
      i_icon_quote : 'https://i35.servimg.com/u/f35/18/21/60/73/quote-15.png?color=primary&size=s',
      i_icon_multiquote_off : 'https://i35.servimg.com/u/f35/18/21/60/73/multi-15.png?color=primary&size=s',
      i_icon_multiquote_on : 'https://i35.servimg.com/u/f35/18/21/60/73/multi-15.png?color=secondary&size=s',
      i_icon_thanks_off : 'https://i35.servimg.com/u/f35/18/21/60/73/thanks15.png?color=primary&size=s',
      i_icon_thanks_on : 'https://i35.servimg.com/u/f35/18/21/60/73/thanks15.png?color=secondary&size=s',
      i_icon_edit : 'https://i35.servimg.com/u/f35/18/21/60/73/edit-t10.png?color=primary&size=s',
      ...
      i_msg_newpost : 'https://i35.servimg.com/u/f35/18/21/60/73/new-pm15.png?color=primary&size=m',
    ...
    gallery : {
      upload_pic : 'https://i35.servimg.com/u/f35/18/21/60/73/upload15.png?color=primary&size=m'
    }
  ...
  javascripts : {
    ...
    '[FA EDGE] ALL.JS' : {
      widget_menu_title : '<div class="title module_column_title">Modyul Menu</div>',
      ...
      quick_nav_title : "title : 'Madaliaang nabigasyon'",
      quick_nav_tooltip : "tooltip : 'I-toggle ang madaliang nabigasyon'",
      quick_nav_notif : 'Patalastas',
      tool_copy_url_tooltip : 'Kopyahin ang BBCode URL',
      tool_copy_url_prompt : 'Kopyahin ang BBCode URL sa ibaba. (CTRL+C)',
      tool_admin_panel : 'Kontrols ng Administrasyon',
      tool_to_top : 'Itaas ng pahina',
      tool_to_bottom : 'Ibaba ng pahina',

      img_resizer_full_size : 'Ipakita ng lubos ang laki',
      img_resizer_enlarge : 'Palakihin ang larawan',
      img_resizer_reduce : 'Paliitin ang larawan',
      img_resizer_download : 'I-download ang larawan',
  ...
  templates : {
    ...
    'overall_footer_end.html' : {
      ...
      fae_feedback : 'I-submit ang katugunan',
      fae_feedback_tooltip : 'Tumulong upang mapabuti ang Forumactif Edge'
    },


    logged_out_reply : {
      main_title : '<h2 class="lor_maintitle">Gumawa ng isang account o lumagda para mag-iwan ng reply</h2>',
      main_desc : '<p class="lor_maindesc">Kailangan mo maging isang miyembro upang mag-iwan ng reply.</p>',

      create_account_title : '<h3 class="lor_subtitle">Gumawa ng account</h3>',
      create_account_desc : '<p class="lor_subdesc">Sumali sa aming community sa pamamagitan ng paggawa ng bagong account. Madali lang ito!</p>',
      create_account_button : '<a href="/register" class="button1">Gumawa ng bagong account</a>',

      log_in_title : '<h3 class="lor_subtitle">Mag-log in</h3>',
      log_in_desc : '<p class="lor_subdesc">Mayroon ka nang account? Walang problema, mag-log in dito</p>',
      log_in_button : '<a href="/login" class="button1">Mag-log in</a>'
    }
  ...
  fae_cp : {
    fae_cp_main_title : 'Mga Kontrols ng Forumactif Edge',
    fae_cp_desc : 'Itong panel ay nagbibigay daan sa iyo sa pag install, uninstall, at update ng <a href="https://github.com/SethClydesdale/forumactif-edge" target="_blank">Forumactif Edge</a>. Maghanda na upang maranasan ng iyong forum sa isang mas modernong at madaling tablang paraan!',
    fae_log : 'Mga log',
    fae_actions : 'Aksyons',

    fae_install : 'I-install',
    fae_reinstall : 'Muling i-install',
    fae_install_complete : 'TAPOS!',
    fae_install_warning : 'Sigurado ka bang gusto mong {INSTALL} ang Forumactif Edge? Ito ay tatanggalin ang iyong kasakuluyang theme at iyong kasakuluyang JavaScripts.\\\n\\\nMangyari sana siguradohin na i-backup ang lahat ng iyong personal content files katulad ng CSS, Templates, at JavaScripts bago magpatuloy. I-click ang "Cancel" kapag ikaw pa ay hindi pa handang i-install ang Forumactif Edge.',

    fae_uninstall : 'I-uninstall',
    fae_uninstall_warning : 'Sigurado ka bang gusto mong i-uninstall Forumactif Edge? Lahat ng CSS, JavaScript, at Template na pagbabago ay matatangal ; Ang iyong forum ay muling mababalik sa normal na phpbb3 theme.\\\n\\\nMangyari sana siguradohin na i-backup ang lahat ng iyong personal content files katulad ng CSS, Templates, at JavaScripts bago magpatuloy. I-click ang "Cancel" kapag ikaw pa ay hindi pa handang i-uninstall ang Forumactif Edge.',

    fae_update : 'Mag check ng bagong update',
    fae_update_good : 'Ang Forumactif Edge ay nasa tamang bersyon!',
    fae_update_check : 'Humahanap ng updates sa Github...',
    fae_update_prepare : 'Hinahandang ibigay ang instruksyon ng update, mangyaring huwag isara ang tab na ito...',
    fae_update_start : 'Ang update ay malapit nang magsimula, mangyaring huwag isara ang tab na ito.',
    fae_update_fetch : 'Kumkuha ng instruksyon sa update para sa bersyon {VERSION_STRING}... ({UPDATE_MIN}/{UPDATE_MAX})',
    fae_update_notes : 'Mangyaring <a href="{RELEASE_TAG}" target="_blank">i-click ito</a> para malaman ang mga bago sa bersyon {VERSION_STRING}.',
    fae_update_error : 'Instruksyon ng update para sa bersyon {VERSION_STRING} ay hindi makita. Mangyaring <a href="http://fmdesign.forumotion.com/t700-forumactif-edge-support#13923" target="_blank">gumawa ng support ticket</a> at ibigay itong impormasyon para sa karagdagang tulong.',

    fae_translate : 'Palitan ang wika',
    fae_translate_same : 'Ang wika ng Forumactif Edge ay {LANG} na talaga. Mangyaring pumili ng ibang wika.',
    fae_translate_warning : 'Sigurado ka bang gusto mong baguhin ang wika ng Forumactif Edge sa {LANG}?',
    fae_translate_start : 'Ang pagsasalin ng wika ng Forumactif Edge ay magsisimula na sa ilang sandali. Mangyaring maghintay...',
